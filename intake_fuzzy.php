...
$_SESSION['cibsr_search'] = null;

if (empty($_SESSION['cibsr_search'])) {
    $records = $module->getSearchArray();
    $_SESSION['cibsr_search'] = $records;

    //$_SESSION['cibsr_fuse'] = $fuse;
} else {
...
//                $("#reportModal").find('.modal-title').text('Set the House ID for this person: '+ formValues.firstname+ " "+ formValues.lastname);
